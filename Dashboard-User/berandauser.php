                        ...
                        <div class="col-sm-3">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><?php echo $row['penyelenggara']; ?></p>
                                    <p class="card-text">Periode Berasiswa : <?php echo $row['tenggatbeasiswa']; ?> </p>
                                </div>
                                <div class="card-footer text-muted">
                                    <center><a href="viewbeasiswa.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Selengkapnya</a></center>
                                </div>
                            </div>
                        </div>
                    <?php
