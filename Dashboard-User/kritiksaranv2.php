...
<body>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
        <div class="kritiksaranv2" ><b>Kritik Saran</b></div>
        ...
        <form action="" method="POST" >
                ...
                <div class="form-group">
                    <label for="pwd">Kritik:</label>
                    <input type="text" class="form-control" name="kritik" required >
                </div>
                <div class="form-group">
                    <label for="pwd">Saran:</label>
                    <input type="text" class="form-control" name="saran" required >
                </div>
                <div class="form-group" required>
                    <label for="pwd">Rating:</label><br>
                    <tr>
								<th></th>
								<td><input type="radio" name="rating" value="4" /> Sangat Baik</td>
							<tr>
								<th></th>
								<td><input type="radio" name="rating" value="3" /> Baik</td>
							</tr>
							<tr>
								<th></th>
								<td><input type="radio" name="rating" value="2" /> Cukup</td>
							</tr>
							<tr>
								<th></th>
								<td><input type="radio" name="rating" value="1" /> Kurang</td>
							</tr>
                </div>
                <div class="buttoninput">
                    <input class="btn btn-primary" type="submit" name="submit" role="button" style="float:right;" ></input>
                </div>
            </form>
        </div>
        <div class="col-lg-2"></div>
