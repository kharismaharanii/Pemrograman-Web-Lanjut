        ...
        <div class="main_body">
            ...
            <div class="container">
                ...
                <div class="content read">
                    <h2>Data Beasiswa</h2>
                    <a href="tambahbeasiswa.php" class="create-contact">Tambah Beasiswa</a>
                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM beasiswa ORDER BY id ASC limit $halaman_awal, $batas";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['namabeasiswa']; ?></td>
                                    <td><?php echo $row['tenggatbeasiswa']; ?></td>
                                    <td><?php echo $row['keterangan']; ?></td>
                                    <td><?php echo $row['status']; ?></td>
                                    <td>
                                        <a class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit Data" name="tombol_edit" href="editbeasiswa.php?id=<?php echo $row['id']; ?>"><i class="far fa-edit"></i></a>
                                        <a class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Hapus Data" name="tombol_hapus" href="proses/proses-hapusbeasiswa.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php
