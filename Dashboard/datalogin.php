            ...
            <div class="container">
                <div class="row">
                    <div class="content read">
                        <h2>Data Login</h2>
                        <a href="tambahlogin.php" class="create-contact">Tambah Data</a>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit Data" name="tombol_edit" href="editlogin.php?id=<?php echo $row['id']; ?>"><i class="far fa-edit"></i></a>
                                                <a class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Hapus Data" name="tombol_edit" href="proses/proses-hapuslogin.php?id=<?php echo $row['id']; ?>"><i class="far fa-trash-alt"></i></a>
                                            </center>
                                        </td>
                                    </tr>
                                <?php
